...
class ResourceTargetDefinition(object):
    ...
    def node_name(self) -> str:
        ...
        return self.name if self.attribute == Attribute.PROPERTIES else self.attribute.value
    ...
    def node_label(self) -> str:
        return label_table(self.node_name, requires_recreation=self.requires_recreation.value)

    def render(self, dot: Dot):
        dot.node(self.node_id, self.node_label(), shape='record', color=self._pick_color())
